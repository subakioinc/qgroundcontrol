...
WindowsBuild {
    RC_ICONS = resources/icons/subak.ico
}
...
QGC_APP_NAME        = "SubakGroundStation"
QGC_ORG_NAME        = "Subak.io"
QGC_ORG_DOMAIN      = "io.subak"
QGC_APP_DESCRIPTION = "Open source ground control app provided by QGroundControl dev team"
QGC_APP_COPYRIGHT   = "Copyright (C) 2017 QGroundControl Development Team. All rights reserved."

WindowsBuild {
    QGC_INSTALLER_ICON          = "WindowSubak.ico"
...
CustomBuild {
    ...
    DEFINES += QGC_APPLICATION_NAME=\"\\\"SubakGroundStation\\\"\"
    DEFINES += QGC_ORG_NAME=\"\\\"Subak.io\\\"\"
    DEFINES += QGC_ORG_DOMAIN=\"\\\"io.subak\\\"\"
    RESOURCES += \
